...
class VBCourtsPassFF002_010(unittest.TestCase):
    #testing on firefox
...
class NumCourts002(VBCourtsPassFF002_010):    
...
class NumCourts003(VBCourtsPassFF002_010):    
...
class NumCourts004(VBCourtsPassFF002_010):    
...
class NumCourts005(VBCourtsPassFF002_010):    
...
class NumCourts006(VBCourtsPassFF002_010):    
...
class NumCourts007(VBCourtsPassFF002_010):    
...
class NumCourts008(VBCourtsPassFF002_010):    
...
class NumCourts009(VBCourtsPassFF002_010):    
...
class NumCourts010(VBCourtsPassFF002_010):    
